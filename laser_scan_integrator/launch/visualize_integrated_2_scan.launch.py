...
def generate_launch_description():
    ...
    pointCloudTopic = LaunchConfiguration('integratedTopic', default="integrated_scan")
    ...
    robotFrontEnd = LaunchConfiguration('robotFrontEnd', default=0.4925314)
    robotRearEnd = LaunchConfiguration('robotRearEnd', default=-0.4925314)
    robotRightEnd = LaunchConfiguration('robotRightEnd', default=-0.267477)
    robotLeftEnd = LaunchConfiguration('robotLeftEnd', default=0.267477)
